...
public class Fragment_Animalother extends Fragment {
	...
	public static Fragment_Animalother newInstance(String text) {

		Fragment_Animalother f = new Fragment_Animalother();
		Bundle b = new Bundle();
	...
	public void display() {
		...
		lsCustomerDetails = db.getCustomerDetailother();
